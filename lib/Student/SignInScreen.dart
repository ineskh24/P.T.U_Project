...
import 'package:e_learning/Student/SingUP.dart';
...
class _SignInScreenStudentState extends State<SignInScreenStudent> {
  ...
  Future<Map<String, dynamic>?> _login() async {
    try {
      ...
      print(
        "Number of matching documents: ${querySnapshot.docs.length} ${_passwordController.text} $_IdController.text{}",
      );
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => ProfileStudent(userData: userData),
          ),
        );
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Mot de passe ou ID incorrect')));
        return null;
      }
    } catch (e) {
